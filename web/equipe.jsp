...
<html>
    ...
    <body>
        ...
        <div class="form-group">
            ...
            <BR>
            <div class="form-group">
                <input type="button" id="idBotao" class="btn btn-primary" value="Imprimir Dados Inscrição" onClick="window.open('relatorioDadosInscricao.jsp?idCompEquipe=<%=competEquipe.getId()%>');" value="blank">
            </div> 
    </body>
</html>
